            ...
            <div class="navbar">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" id="heroDetails">
                        <p>
                            Organization Name: <c:out value="${organization_model.organizationName}"/> 
                        </p>
                        <p>
                            Description: <c:out value="${organization_model.description}"/>
                        </p>
                        <p>
                            Location: <c:out value="${location_model.locationName}"/>
                        </p>
                        <p>
                            Location: <c:out value="${location_model.description}"/>
                        </p>
                    </div>
                </div>
