        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4" id="heroDetails">
                    <p>
                        Member Alias: <c:out value="${hero_model.alias}"/> 
                    </p>
                    <p>
                        Organization Name: <c:out value="${organization_model.description}"/>
                    </p>
                    <p>
                        Start Date: <c:out value="${member_model.startDate}"/>
                    </p>
                    <p>
                        End Date: <c:out value="${member_model.endDate}"/>
                    </p>
                </div>
            </div>
