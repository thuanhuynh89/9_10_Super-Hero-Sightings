            ...
            <div class="navbar">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" id="heroDetails">
                        <p>
                            StreetNumber: <c:out value="${address_model.streetNumber}"/> 
                        </p>
                        <p>
                            StreetName: <c:out value="${address_model.streetName}"/>
                        </p>
                        <p>
                            City: <c:out value="${address_model.city}"/>
                        </p>
                        <p>
                            State_Province: <c:out value="${address_model.state_Province}"/>
                        </p>
                        <p>
                            Country: <c:out value="${address_model.country}"/> 
                        </p>
                        <p>
                            Planet: <c:out value="${address_model.planet}"/>
                        </p>
                        <p>
                            Galaxy: <c:out value="${address_model.galaxy}"/>
                        </p>
                        <p>
                            Latitude: <c:out value="${address_model.latitude}"/>
                        </p>
                        <p>
                            Latitude: <c:out value="${address_model.longitude}"/>
                        </p>
                    </div>
                </div>
            </div>
