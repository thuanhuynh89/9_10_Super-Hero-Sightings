            ...
            <div class="navbar">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" id="heroDetails">
                        <p>
                            Alias: <c:out value="${hero_model.alias}"/> 
                        </p>
                        <p>
                            First Name: <c:out value="${hero_model.firstName}"/>
                        </p>
                        <p>
                            Last Name: <c:out value="${hero_model.lastName}"/>
                        </p>
                        <p>
                            Description: <c:out value="${hero_model.description}"/>
                        </p>
                    </div>
                </div>
            </div>
