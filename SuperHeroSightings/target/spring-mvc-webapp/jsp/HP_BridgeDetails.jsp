            ...
            <div class="navbar">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" id="heroDetails">
                        ...
                        <tr>Alias: ${hero_model.alias}</tr></br>  
                        <tr>First Name: ${hero_model.firstName}</tr></br>
                        <tr>Last Name: ${hero_model.lastName}</tr></br>
                        <tr>Hero Description: ${hero_model.description}</tr></br>
                        <c:forEach var="currentHP" items="${hpList}">
                            <tr>Power Description: ${currentHP.power.description}</tr></br>
                        </c:forEach>
                    </div>
                </div>
