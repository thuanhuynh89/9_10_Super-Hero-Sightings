        ...
        <div class="container">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="location"
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="add-address" class="col-md-4" id="right">Address:</label>
                        <div class="col-md-4">

                        <sf:select  path="address.addressId" id="addressDropDown"  >
                            <c:forEach var="addressList" items="${addressList}">
                                <sf:option value="${addressList.addressId}">${addressList.streetNumber} ${addressList.streetName} 
                                ${addressList.city} ${addressList.state_Province}</sf:option>
                            </c:forEach>
                        </sf:select>
                    
                        <sf:errors path="address.addressId" cssclass="error"></sf:errors>

                        <sf:hidden path="address.addressId"/>
                        <sf:hidden path="location"/>
                    </div>
                </div>
                <div class="form-group">
